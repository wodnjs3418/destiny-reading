                ...
                {isLoadingAI && (
                  <div style={{
                    ...
                    <p style={{ color: 'rgba(232, 230, 227, 0.6)', fontSize: '14px', marginTop: '10px' }}>
                      GPT-4o is generating your personalized reading
                    </p>
                  </div>
                )}
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      <h3 style={{
                        ...
                        AI Personalized Destiny Reading
                      </h3>
                    </div>
                    ...
                    <div style={{
                      ...
                      <p style={{ color: 'rgba(232, 230, 227, 0.6)', fontSize: '12px' }}>
                        ✨ This personalized reading was generated by GPT-4o based on your unique birth chart
                      </p>
                    </div>
                  </div>
                )}
